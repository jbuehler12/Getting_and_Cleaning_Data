...
This is a code book which describes the data source, variables, transformations and work performed to clean up the data.

**Original data source:**
https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip

**Original description of data set:**
...
Transformation done on Data Set:
